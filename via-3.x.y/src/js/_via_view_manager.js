...
function _via_view_manager(data, view_annotator, container) {
  ...
  data.on_event('project_loaded', _ID, this._on_event_project_loaded.bind(this));
  data.on_event('project_updated', _ID, this._on_event_project_updated.bind(this));
  data.on_event('view_bulk_add', _ID, this._on_event_view_bulk_add.bind(this));
  data.on_event('view_del', _ID, this._on_event_view_del.bind(this));
  view_annotator.on_event('view_show', _ID, this._on_event_view_show.bind(this));
  view_annotator.on_event('view_next', _ID, this._on_event_view_next.bind(this));
  view_annotator.on_event('view_prev', _ID, this._on_event_view_prev.bind(this));

  this._init_ui_elements();
}

(function() {
  const proto = _via_view_manager.prototype;
  proto._init = _init;
  proto._init_ui_elements = _init_ui_elements;
  proto._on_pname_change = _on_pname_change;
  proto._on_view_selector_change = _on_view_selector_change;
  proto._on_next_view = _on_next_view;
  proto._on_prev_view = _on_prev_view;
  proto._on_event_view_show = _on_event_view_show;
  proto._on_event_view_next = _on_event_view_next;
  proto._on_event_view_prev = _on_event_view_prev;
  proto._on_event_project_loaded = _on_event_project_loaded;
  proto._on_event_project_updated = _on_event_project_updated;
  proto._view_selector_clear = _view_selector_clear;
  proto._view_selector_option_html = _view_selector_option_html;
  proto._view_selector_update = _view_selector_update;
  proto._view_selector_update_regex = _view_selector_update_regex;
  proto._view_selector_update_showall = _view_selector_update_showall;
  proto._on_view_filter_regex_change = _on_view_filter_regex_change;
  proto._file_add_from_filelist = _file_add_from_filelist;
  proto._on_add_media_local = _on_add_media_local;
  proto._file_add_local = _file_add_local;
  proto._on_event_view_bulk_add = _on_event_view_bulk_add;
  proto._on_add_media_remote = _on_add_media_remote;
  proto._on_add_media_bulk = _on_add_media_bulk;
  proto._on_add_media_bulk_file_selected = _on_add_media_bulk_file_selected;
  proto._on_add_media_bulk_file_load = _on_add_media_bulk_file_load;
  proto._on_del_view = _on_del_view;
  proto._on_event_view_del = _on_event_view_del;
  ...
  function _init_ui_elements() {
    ...
    this.view_filter_regex.setAttribute('placeholder', 'Filter');
  ...
  //
  function _on_pname_change(e) {
    this.d.store.project.pname = e.target.value.trim();
  }

  function _on_view_selector_change(e) {
  ...
  function _on_event_view_show(data, event_payload) {
  ...
  function _on_event_view_next(data, event_payload) {
    this._on_next_view();
  }

  function _on_event_view_prev(data, event_payload) {
    this._on_prev_view();
  }

  function _on_event_project_loaded(data, event_payload) {
    this._init_ui_elements();
    this._view_selector_update();
  ...
  function _on_event_project_updated(data, event_payload) {
  ...
  // View Selector
  //
  function _view_selector_clear() {
    this.view_selector.innerHTML = '';
    this.view_selector_vid_list = [];
  }

  function _view_selector_option_html(vindex, vid) {
  ...
  function _view_selector_update() {
  ...
  function _view_selector_update_regex(regex) {
    if ( regex === '' ||
  ...
  function _view_selector_update_showall() {
  ...
  function _on_view_filter_regex_change() {
    var regex = this.view_filter_regex.value;
    this._view_selector_update_regex(regex);
  }

  function _file_add_from_filelist(filelist) {
  ...
  function _on_event_view_bulk_add(data, event_payload) {
    this._view_selector_update();
  ...
  function _on_event_view_del(data, event_payload) {
    this._view_selector_update();
